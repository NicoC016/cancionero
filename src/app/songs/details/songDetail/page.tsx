...
export default function SongDetail({ id }: {id:number}) {
  ...
  return (
    <div className="flex justify-center items-center flex-col p-10">
        <div className="border-b border-border pb-4 w-full flex justify-center items-center flex-col">
            <div className="flex items-start justify-between gap-4 w-auto">
                <div>
                  <h1 className="capitalize font-serif text-2xl text-foreground mb-2">
            ...
            {
                song?.link? (
                    <div className="hidden md:w-[72%] md:flex items-center gap-2 mt-4 pt-4 border-t border-border">
                        <div className="flex">
                          <Button
                            variant="outline"
                            size="sm"
